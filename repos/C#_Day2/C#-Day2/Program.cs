    ...
    internal class Program
    {
        ...
        public static void program6()
        {
            try
            {
                ...
                MethosOverloading.print(age,favnumber);
                MethosOverloading.print(age);
                MethosOverloading.print(age,name);
            }
            catch (Exception ex)
            {
                Console.WriteLine(ex.Message);
        ...
        public static void program7()
        {
            try
            {
                ...
                var nnumber1 = Console.ReadLine();
                Console.WriteLine("please Enter number1");
                var nnumber2 = Console.ReadLine();
                Console.WriteLine("please Enter number1");
                var nnumber3 = Console.ReadLine();
            ...
            MethosOverloading.Add(4, 50);
            MethosOverloading.Add(8.2, 78.12);
            MethosOverloading.Add(4, 50,8);
